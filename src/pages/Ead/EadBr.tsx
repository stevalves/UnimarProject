    ...
    <section id="braz" className="min-h-screen flex items-center justify-center border-b border-forest-50">
      <div className="container mx-auto flex flex-col gap-2">
        ...
        <div className="flex flex-col shadow-lg gap-2 xl:gap-4 bg-forest-50 rounded px-2 py-6 xl:py-14">
          ...
          <div className="self-center flex flex-col shadow-2xl p-2 rounded gap-2 border border-forest-900">
            <h6>Resumindo, o apontamento levantou que entre 2011 a 2012 o EAD teve:</h6>
            <p data-aos="fade-down" data-aos-delay="150" data-aos-once className="underline">Um aumento de <strong>474%</strong> de ingressantes;</p>
            <p data-aos="fade-down" data-aos-delay="300" data-aos-once className="underline">Uma diminuição dos cursos presenciais em <strong>23,4%</strong>;</p>
            <p data-aos="fade-down" data-aos-delay="450" data-aos-once className="underline">Um aumento no total de ingressos de <strong>18,4%</strong> para <strong>62,8%</strong>.</p>
          </div>
        </div>
      </div>
    </section>
