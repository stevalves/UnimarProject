...
const Logged = () => {
  ...
  return (
    <nav ref={ref} className="flex items-center gap-4 border-l border-forest-50 pl-4 h-max sm:relative">
      <Link to="/unitalk/profile" className="border border-forest-50 px-2 py-1 hover:bg-forest-50 hover:text-forest-900 duration-300 transition-colors sm:w-max w-1/3 text-center rounded sm:flex hidden">{user.split(" ")[0]}</Link>
      ...
      <div className={list_tv({ open })}>
        <Link to="/unitalk/profile" className="w-full text-center border-b py-2 hover:text-forest-700">Perfil</Link>
